    ...
    justify-between items-center mx-auto">
      <router-link to="/" class="flex items-center">
        ...
        >
          ...
          <path
            class="transition ease-in-out translate-x-0 hover:translate-x-1"
      ...
      >
        ...
        >
          <li>
            <router-link
              to="/"
              class="block py-2 pr-4 pl-3 hover:text-blue-400
                hover:underline
                hover:underline-offset-4
              transition ease-in-out duration-300 delay-100 
              rounded md:bg-transparent md:text-blue-900 md:p-0 dark:text-white"
              aria-current="page"
              >Home</router-link
            >
          </li>
